...
class Harvester(object):
    ...
    def __get_request__(self, api_url, extra_params=None):
        """
...
class Forecaster(object):
    ...
    """
    The below functions pull data from the Forecast API
    ...
    def __get_api_data__(self, api_url, extra_params=None):
        """
